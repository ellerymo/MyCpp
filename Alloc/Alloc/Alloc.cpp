		...
		*/
		...
		else
		{
			...
			if (LeftBytes > 0)
			{
				...
				(Obj*)_Start->Free_List_Link = Free_List[Index];
				Free_List[Index] = _Start;
...
template <bool threads, int inst>
typename _Default_Alloc_Template<threads, inst>::Obj* _Default_Alloc_Template<threads, inst>::Free_List[_NFREELISTS] = { 0 };
